...
纸带消耗量**只由曲目时长决定**(与 BPM、每拍格数无关):

```
1 秒音乐 = feed_mm_s(默认 16)= 16 mm 纸带   →   1 分钟 ≈ 0.96 m
```
...
⇒ **一支完整的曲子(30 秒以上)通常就要 1 米左右**。市面上那种几十厘米的短纸带,
打一首完整曲子会"意犹未尽"地断在半路;而**整卷太短时更尴尬——最后剩下的纸带不够一首曲子**,
只能打半首浪费掉。所以按"整卷能打几首"来买,比按"每卷多少钱"买更划算。
